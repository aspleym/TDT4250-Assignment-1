...
public class ProgrammeImpl extends MinimalEObjectImpl.Container implements Programme {
	...
	public EList<Specialisation> getSpecialisations() {
		if (specialisations == null) {
			specialisations = new EObjectContainmentWithInverseEList<Specialisation>(Specialisation.class, this, SpPackage.PROGRAMME__SPECIALISATIONS, SpPackage.SPECIALISATION__SPECIALISATION_IN);
		}
